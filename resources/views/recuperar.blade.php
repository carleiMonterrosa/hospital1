...
<head>
    ...
    <style>
        /* ===== TODOS TUS ESTILOS AQUÍ (MANTENLOS IGUAL) ===== */
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    ...
                    @else
                        <i class="fas fa-key" style="font-size: 3.5rem; color: #2e7d32; margin-bottom: 10px; display: block;"></i>
                    @endif
                    
                    <h1><i class="fas fa-key"></i> Recuperar Contraseña</h1>
                    <p>Ingresa tu usuario y escribe tu nueva contraseña</p>
